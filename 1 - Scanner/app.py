...
<style>
  ...
  h1{{margin:4px 0 10px;color:var(--accent)}} p{{color:var(--surface-muted)}}
...
<style>
  ...
  p,li{{color:var(--surface-text)}} a{{color:#0b5bd7;text-decoration:none}}
  code{{background:#fff;color:var(--surface-text);padding:2px 6px;border-radius:4px;font-family:monospace;border:1px solid var(--surface-border);color:var(--surface-text)}}
  pre{{background:#fff;color:var(--surface-text);border:1px solid var(--surface-border);padding:16px;border-radius:8px;overflow-x:auto}}
  .note-banner{{
    background:var(--surface-bg);
    border:1px solid var(--surface-border);
...
<style>
  ...
  code{{background:#fff;color:var(--surface-text);padding:2px 6px;border-radius:4px;font-family:monospace;border:1px solid var(--surface-border);color:var(--surface-text)}}
  pre{{background:#fff;color:var(--surface-text);border:1px solid var(--surface-border);padding:16px;border-radius:8px;overflow-x:auto;font-size:13px}}
  a{{color:#a7c5ff}}
